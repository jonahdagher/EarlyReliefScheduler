...
for day in all_days:
    working_330 = set(get_provider_names_working_time_on_day(session, day, "330"))
    time_dict["330"][day] = working_330

for day in all_days:
    working_930 = set(get_provider_names_working_time_on_day(session, day, "930"))
